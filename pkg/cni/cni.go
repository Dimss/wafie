...
func cmdAdd(args *skel.CmdArgs) error {
	...
	logger.Println("CMD ADD GET CALLED")
...
func cmdDel(args *skel.CmdArgs) error {
	...
	_ = conf
	logger.Println("CMD DEL GET CALLED")
	// Do your delete here
...
func main() {
	...
	skel.PluginMainFuncs(skel.CNIFuncs{
		...
		Status: cmdStatus,
		/* FIXME GC */
	}, version.All, bv.BuildString("wafie"))

	logger.Println("CMD MAIN GET CALLED")

}

func cmdCheck(_ *skel.CmdArgs) error {
	logger.Println("checking cmd")
	return nil
}
...
func cmdStatus(args *skel.CmdArgs) error {
	...
	_ = conf
	logger.Println("CMD STATUS GET CALLED")
